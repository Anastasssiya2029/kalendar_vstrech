...
$eyebrowFont = [System.Drawing.Font]::new('Segoe UI', 15, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
...
$heartFont = [System.Drawing.Font]::new('Segoe UI Symbol', 25, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
$pillFont = [System.Drawing.Font]::new('Segoe UI', 16, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)

$graphics.DrawString('ШКОЛА АУТЕНТИЧНОГО МАРКЕТИНГА', $eyebrowFont, $purpleBrush, 82, 130)
$graphics.DrawString('Календарь', $titleFont, $headingBrush, 78, 174)
$graphics.DrawString('встреч', $titleFont, $headingBrush, 78, 237)
$graphics.DrawString('Планирование встреч команды', $bodyFont, $bodyBrush, 82, 338)
$graphics.DrawString('Сухаревой Анастасии', $bodyFont, $bodyBrush, 82, 374)
$graphics.DrawString([char]0x2665, $heartFont, $purpleBrush, 365, 373)
...
$graphics.DrawString('Школа аутентичного маркетинга Сухаревой Анастасии', $footerFont, $bodyBrush, 82, 526)

$bitmap.Save($OutputPath, [System.Drawing.Imaging.ImageFormat]::Png)

$footerFont.Dispose(); $pillFont.Dispose(); $heartFont.Dispose(); $bodyFont.Dispose(); $titleFont.Dispose(); $eyebrowFont.Dispose()
