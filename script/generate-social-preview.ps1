...
$eyebrowFont = [System.Drawing.Font]::new('Segoe UI', 13, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
...
$graphics.DrawString('ШКОЛА АУТСОРСИНГОВОГО МАРКЕТИНГА', $eyebrowFont, $purpleBrush, 82, 132)
...
$graphics.DrawString('Сухарева MTC', $bodyFont, $bodyBrush, 82, 374)
...
$graphics.DrawString('Школа аутсорсингового маркетинга Сухарева MTC', $footerFont, $bodyBrush, 82, 526)
